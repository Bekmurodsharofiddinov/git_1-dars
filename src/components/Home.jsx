...
import img from '../assets/images/left-image.jpg'
import img1 from '../assets/images/right-image.jpg'
import { Container, Typography } from '@mui/material';
import rasm from '../assets/images/page-bg.jpg'
        ...
        <Typography sx={{ width: '100%', float: "right", backgroundImage: `url(${rasm})` }}>
            ...
            <Grid sx={{ width: '65%', float: 'right' }}>
                <Grid xs={12} sm={12} md={12} sx={{ width: '80%', textAlign: 'center', color: 'white', pt: '60px', display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
                    ...
                    <Typography sx={{ borderBottom: '1px solid red', width: '4%', mt: "10px", mb: "10px" }}></Typography>
                ...
                <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }} sx={{ mt: '50px', color: 'white' }}>
                    ...
                    <Grid item xs={12} sm={12} md={6}>
                        ...
                        <Grid container sx={{ marginTop: "20px", textAlign: "center" }}>
                            <Button variant="contained" sx={{ width: "30%", p: "2%", background: "white", color: "#58363A", borderRadius: "1px", fontWeight: 800 }}>Read More</Button>
                ...
                <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }} sx={{ mt: '40px', color: 'white' }}>
                    ...
                    <Grid item xs={12} sm={10} md={6}>
                        ...
                        <Button variant="contained" sx={{ width: "30%", p: "2%", background: "white", color: "#58363A", borderRadius: "1px", fontWeight: 800, mt:"20px" }}>Read More</Button>
                    </Grid>
